...
var paper = function (u, F) {
    var T = (u = u || require("./node/self.js")).window,
        ...
        D = new (function () {
            function n(t, e, n) {
                ...
                return (
                    t &&
                        ((i = d(t, "length")) && "number" == typeof i.value
                            ? s
                            : function (t, e) {
                                  for (var n in this)
            ...
            function h(a, o, h, u, l) {
                ...
                function t(t, e) {
                    ...
                    (l && s) ||
                        ...
                        (d(a, t) || { configurable: !0 }).configurable &&
                            ((r.configurable = !0),
                            (r.enumerable = null != h ? h : !n)),
                        f(a, t, r));
                }
                if (o) {
                ...
                statics: {
                    ...
                    equals: function (t, e) {
                        ...
                        if (
                            ...
                            if (Array.isArray(t) && Array.isArray(e)) {
                                ...
                                var n,
                                    i = Object.keys(t);
                                if ((n = i.length) !== Object.keys(e).length)
                                    return !1;
                                for (; n--; ) {
                                    var r = i[n];
                                    if (
                    ...
                    read: function (t, e, n, i) {
                        ...
                        return (
                            (i = i || r - o),
                            e instanceof this ||
                            (n && n.readNull && null == e && i <= 1)
                                ? (a && (t.__index = o + 1),
                                  e && n && n.clone ? e.clone() : e)
                                : ((e = D.create(s)),
                                  a && (e.__read = !0),
                                  (e =
                                      e.initialize.apply(
                    ...
                    deserialize: function (t, e, n, i, r) {
                        ...
                        if (((n = n || {}), Array.isArray(t))) {
                            ...
                            for (
                                ...
                                s.push(D.deserialize(t[c], e, n, u, o));
                            h &&
                                ((l = s), (s = e ? e(h, l, a || r) : new h(l)));
                        } else if (D.isPlainObject(t))
                            for (var f in ((s = {}),
                            i && (n.dictionary = s),
                            t))
                                s[f] = D.deserialize(t[f], e, n);
                        return o ? s[1] : s;
                    },
                    ...
                    splice: function (t, e, n, i) {
                        ...
                        e && D.push(i, e);
                        for (
                            var o = t.splice.apply(t, i), a = 0, h = o.length;
                            a < h;
                            a++
                        )
                            o[a]._index = F;
                        for (a = n + r, h = t.length; a < h; a++)
                            t[a]._index = a;
                        return o;
                    },
        ...
        l = D.extend({
            ...
            initialize: function t() {
                ...
                this.support ||
                    ...
                    ht.release(n)),
                    this.agent ||
                        ((e = u.navigator.userAgent.toLowerCase()),
                        (n = (/(darwin|win|mac|linux|freebsd|sunos)/.exec(e) ||
                            [])[0]),
                        (s =
                            i.agent =
                            i.browser =
            ...
            findBoundsCollisions: function (t, e, n, i, r) {
                ...
                for (var v = [], p = new Array(o), g = 0; g < h; g++) {
                    ...
                    if (v.length) {
                        var S = u(v, c, y[l] - n) + 1;
                        if ((v.splice(0, S), s && r))
                            for (var C = C.concat(v), P = 0; P < v.length; P++)
                                p[(T = v[P])].push(w);
                        else
                            for (
                                var I = y[f], M = y[d], P = 0;
                    ...
                    x && (t === e && C.push(m), (p[m] = C)),
                        v.length
                            ? ((y = u(v, c, y[c])), v.splice(y + 1, 0, m))
                            : v.push(m);
                }
    ...
    var q = new (function () {
                ...
                solveCubic: function (e, n, i, r, t, s, a) {
                    ...
                    if (
                        ...
                        var _ = c / e,
                            ...
                            _ =
                                0 < _
                                    ? 1.324717957244746 * Math.max(g, y(_))
                                    : g,
                            p = o - v * _;
                        if (p !== o) {
                            for (
                        ...
                        "number" == i
                            ...
                            : ((t =
                              ...
                              Array.isArray(t)
                                  ...
                                  : "angle" in t
                                  ? (this._set(t.length || 0, 0),
                                    this.setAngle(t.angle || 0))
                                  : (this._set(0, 0), (s = 0))),
                        r && (this.__read = s),
                        this
                    );
        ...
        b = D.extend(
            {
                        ...
                        : 1 === l.length &&
                          (Array.isArray(t)
                              ...
                              : t.from === F &&
                                t.to === F &&
                                (this._set(0, 0, 0, 0),
                                D.readSupported(l, this) && (r = 1))),
                        r === F &&
                            ((a = L.readNamed(l, "from")),
                            (s = D.peek(l)),
                            (c = a.x),
                            (a = a.y),
                            (s && s.x !== F) || D.hasNamed(l, "to")
                                ? ((o = (u = L.readNamed(l, "to")).x - c),
                                  (h = u.y - a),
                                  o < 0 && ((c = u.x), (o = -o)),
                                  h < 0 && ((a = u.y), (h = -h)))
                                : ((o = (u = z.read(l)).width), (h = u.height)),
                            this._set(c, a, o, h),
                            (r = l.__index));
                    l = l.__filtered;
                    return (
                ...
                contains: function (t) {
                    return (t && t.width !== F) ||
                        ...
                        : this._containsPoint(L.read(arguments));
                },
                ...
                scale: function (t, e) {
                    return this.expand(
                        ...
                        this.height * (e === F ? t : e) - this.height,
                    );
                },
            },
            D.each(
        ...
        A = D.extend(
            {
                ...
                apply: function (t, e) {
                    ...
                    return (
                        !!n &&
                        (n.transform(null, D.pick(t, !0), e), this.isIdentity())
                    );
                },
                translate: function () {
                    var t = L.read(arguments),
        ...
        i = e.extend({
            ...
            initialize: function (t) {
                e.call(this, !0),
                    ...
                    (this._currentStyle = new M(null, null, this)),
                    (this._view = Y.create(this, t || ht.getCanvas(1, 1))),
            ...
            getActiveLayer: function () {
                return (
                    this._activeLayer || new a({ project: this, insert: !0 })
                );
            },
            ...
            _insertItem: function (t, e, n) {
                return (
                    (e =
                        ...
                        (
                            this._activeLayer ||
                            this._insertItem(F, new a(V.NO_INSERT), !0)
                        ).insertChild(t, e)),
        ...
        V = D.extend(
            ...
            })(),
            {
                ...
                _initialize: function (t, e) {
                    ...
                    return (
                        ...
                        (this._applyMatrix =
                            this._canApplyMatrix && a.applyMatrix),
                        e && r.translate(e),
                        ((r._owner = this)._style = new M(
                            s._currentStyle,
                            this,
                            s,
                        )),
                        ...
                        (!a.insertItems && (!n || !0 !== t.insert))
                            ? this._setProject(s)
                            : ((n && t.parent) || s)._insertItem(F, this, !0),
                        n &&
                            t !== V.NO_INSERT &&
                            this.set(t, {
                                internal: !0,
                ...
                _serialize: function (i, r) {
                    ...
                    function t(t) {
                        for (var e in t) {
                            ...
                            D.equals(
                                n,
                                "leading" === e ? 1.2 * t.fontSize : t[e],
                            ) || (s[e] = D.serialize(n, i, "data" !== e, r));
                        }
                    }
                    return (
                ...
                _changed: function (t) {
                    var e = this._symbol,
                        ...
                        i = this._project;
                    8 & t &&
                        (this._bounds = this._position = this._decomposed = F),
                        16 & t && (this._globalMatrix = F),
                ...
                function (e) {
                    ...
                    (this["get" + t] = function () {
                        ...
                        (this["set" + t] = function (t) {
                            t != this[n] &&
                                ((this[n] = t), this._changed(i[e] || 257));
                        });
                },
                {},
            ),
            {
                ...
                setPosition: function () {
                    this.translate(
                        L.read(arguments).subtract(this.getPosition(!0)),
                    );
                },
            ...
            D.each(
                ...
                },
                {
                    ...
                    _getBounds: function (t, e) {
                        ...
                        return n && n.length
                            ? (V._updateBoundsCache(this, e.cacheItem),
                              V._getBounds(n, t, e))
                            : new b();
                    },
                    ...
                    _getCachedBounds: function (t, e, n) {
                        ...
                        var o,
                            ...
                            e =
                                t.nonscaling ||
                                (e.hasStroke() && !e.getStrokeScaling());
                        return (
                            a &&
                                (n || (this._bounds = n = {}),
                                (o = n[a] =
                    ...
                    statics: {
                        _updateBoundsCache: function (t, e) {
                            ...
                            t &&
                                ...
                                ((n = e._id),
                                (t = t._boundsCache =
                                    t._boundsCache || { ids: {}, list: [] })
                                    .ids[n] ||
                                    (t.list.push(e), (t.ids[n] = e)));
                        },
                        _clearBoundsCache: function (t) {
                            ...
                            if (e) {
                                ...
                                for (
                                    var n = 0, i = e.list, r = i.length;
                                    n < r;
                                    n++
                                ) {
                                    var s = i[n];
                                    s !== t &&
                                        ((s._bounds = s._position = F),
                                        s._boundsCache &&
                                            V._clearBoundsCache(s));
                                }
                            }
                        },
            ...
            ),
            {
                ...
                setScaling: function () {
                    var t,
                        ...
                        i,
                        r = this.getScaling(),
                        s = L.read(arguments, 0, { clone: !0, readNull: !0 });
                    r &&
                        s &&
                        !r.equals(s) &&
                        ((t = this.getRotation()),
            ...
            },
            {
                ...
                clone: function (t) {
                    ...
                    var r = this._name,
                        i = this._parent;
                    if (r && i) {
                        for (var n = i._children, s = r, a = 1; n[r]; )
                            r = s + " " + a++;
                        r !== s && e.setName(r);
                    }
                    return e;
                ...
                rasterize: function (t, e) {
                    ...
                    D.isPlainObject(t)
                        ...
                        : ((a = t), (n = e)),
                        i ? i.matrix.reset(!0) : (i = new d(V.NO_INSERT));
                    ...
                    return (
                        ...
                        r.isZero() ||
                            ((e = i.getContext(!0)),
                            (r = new A().scale(s).translate(t.negate())),
                            e.save(),
                            r.applyToContext(e),
                            this.draw(e, new D({ matrices: [r] })),
                            e.restore()),
                        i.transform(
                            new A().translate(t.add(a.divide(2))).scale(1 / s),
                        ),
                        (n !== F && !n) || i.insertAbove(this),
                        i
                    );
                },
                contains: function () {
                    ...
                    return (
                        t.isInvertible() &&
                        !!this._contains(t._inverseTransform(L.read(arguments)))
                    );
                },
            ...
            new (function () {
                ...
                function e() {
                    var t = arguments,
                        ...
                        n = O.getOptions(t),
                        t = [];
                    return this._hitTest(e, new D({ all: t }, n)), t;
                }
                function n(t, e, n, i) {
            ...
            })(),
            {
                _hitTest: function (i, e, t) {
                    ...
                    var o,
                        ...
                        u = !(
                            ...
                            (e.type && e.type !== D.hyphenate(this._class)) ||
                ...
                matches: function (t, e) {
                    ...
                    n = /^(empty|editable)$/.test(t)
                        ? this["is" + D.capitalize(t)]()
                        : "type" === t
                        ? D.hyphenate(this._class)
                        : this[t];
                    if ("class" === t) {
                ...
                getItem: function (t) {
                    return (
                        V._getItems(this, t, this._matrix, null, !0)[0] || null
                    );
                },
                statics: {
                        ...
                        for (var d = 0, f = l && l.length; d < f; d++) {
                            ...
                            if (u) {
                                ...
                                u.contains(p) ||
                                    (r.overlapping &&
                                        (p.contains(u) ||
                                            r.path.intersects(_, g))) ||
                                    (v = !1);
                            }
                            if (v && _.matches(n) && (c.push(_), s)) break;
                            if (
                                (!1 !== r.recursive && t(_, n, g, r, s),
                                s && 0 < c.length)
                            )
                                break;
                        }
            ...
            },
            {
                ...
                reduce: function (t) {
                    ...
                    if (e && 1 === e.length) {
                        ...
                        return (
                            this._parent
                                ? (t.insertAbove(this), this.remove())
                                : t.remove(),
                            t
                        );
                    }
                ...
                removeChildren: function (t, e) {
                    ...
                    for (
                        var n = D.splice(this._children, null, t, e - t),
                            i = n.length - 1;
                        0 <= i;
                        i--
                    )
                ...
                function (n) {
                    ...
                    this[n] = function () {
                        ...
                        return this.transform(
                            new A()[n](e, t || this.getPosition(!0)),
                        );
                    };
                },
                {
            ...
            ),
            {
                _setStyles: function (t, e, n) {
                    var i,
                        ...
                        a = this._matrix;
                    s.hasFill() &&
                        (t.fillStyle = s.getFillColor().toCanvasStyle(t, a)),
                        s.hasStroke() &&
                            ((t.strokeStyle = s
                                .getStrokeColor()
                                .toCanvasStyle(t, a)),
                        ...
                        s.hasShadow() &&
                            ...
                            (e = (n = n
                                ._shiftless()
                                .prepend(new A().scale(e, e))).transform(
                                new L(s.getShadowBlur(), 0),
                            )),
                        ...
                        if (a.isInvertible()) {
                            ...
                            if (!_) {
                                ...
                                (u = e.offset),
                                    ...
                                    (o = t),
                                    (t = ht.getContext(
                                        g.getSize().ceil().add(1).multiply(a),
                                    )),
                                    1 !== a && t.scale(a, a);
                            }
                            t.save();
                            ...
                            _
                                ? ((t.globalAlpha = c),
                                  f && (t.globalCompositeOperation = l))
                        ...
                        if (
                            ...
                            for (
                                ...
                                var v = d[g],
                                    p = v[0],
                                    v = v[1];
                                t.moveTo(l + p * f, c + v * f),
                                    t.lineTo(l + p * _, c + v * _),
                                    t.stroke();
                            }
                        }
                        if (o) {
                            var m = e._transformCorners(
                                this.getInternalBounds(),
                            );
                            t.beginPath();
                            for (g = 0; g < 8; g++)
                                t[g ? "lineTo" : "moveTo"](m[g], m[++g]);
                            t.closePath(), t.stroke();
                            for (g = 0; g < 8; g++)
                                t.fillRect(m[g] - u, m[++g] - u, n, n);
                        }
                    }
                },
        ...
        _ = V.extend(
            {
                ...
                _equals: function (t) {
                    return (
                        ...
                        D.equals(this._radius, t._radius)
                    );
                },
                copyContent: function (t) {
                ...
                setSize: function () {
                    ...
                    this._size
                        ? this._size.equals(i) ||
                          ...
                          "rectangle" === t
                              ? this._radius.set(
                                    z.min(this._radius, i.divide(2).abs()),
                                )
                              : "circle" === t
                              ? ((e = n = (e + n) / 2), (this._radius = e / 2))
                              : "ellipse" === t &&
                                this._radius._set(e / 2, n / 2),
                          this._size._set(e, n),
                          this._changed(9))
                        : (this._size = i.clone());
                },
                ...
                setRadius: function (t) {
                    ...
                    if ("circle" === e) {
                        ...
                        this._radius.set(t),
                            "rectangle" === e
                                ? ((n = z.max(this._size, t.multiply(2))),
                                  this._size.set(n))
                                : "ellipse" === e &&
            ...
            new (function () {
                function d(t, e, n) {
                    ...
                    if (!i.isZero())
                        for (var r = t._size.divide(2), s = 1; s <= 4; s++) {
                            ...
                            if (
                                new b(n ? o.add(a.multiply(n)) : o, h).contains(
                                    e,
                                )
                            )
                ...
                function f(t, e, n, i) {
                    ...
                    return (
                        (!i || t.isInQuadrant(i)) &&
                        t.subtract(t.normalize()).multiply(e).divide(n)
                            .length <= 1
                    );
                }
                return {
                        ...
                        return (
                            (l || c) &&
                                ...
                                (c = n._tolerancePadding.add(
                                    W._getStrokePadding(
                                        o,
                                        !u.getStrokeScaling() && r,
                                    ),
                                )),
                                (h =
                                    "rectangle" === a
                                        ? (u = d(this, e, (o = c.multiply(2))))
                                            ? f(
                                                  e.subtract(u.point),
                                                  s,
                                                  c,
                                            ...
                                            : ((u = (a = new b(
                                                  this._size,
                                              ).setCenter(0, 0)).expand(o)),
                                              (o = a.expand(o.negate())),
                                              u._containsPoint(e) &&
                                                  !o._containsPoint(e))
                                        : f(e, s, c))),
                            h
                                ? new O(l ? "stroke" : "fill", this)
                                : t.base.apply(this, arguments)
                        );
                    },
                };
        ...
        d = V.extend(
            {
                ...
                initialize: function (t, e) {
                    var n, i;
                    this._initialize(t, e !== F && L.read(arguments)) ||
                        ((i =
                            "string" == (i = typeof t)
                                ? f.getElementById(t)
                                : "object" == i
                            ...
                            (i.getContext || null != i.naturalHeight
                                ? (n = i)
                                : i &&
                                  ((i = z.read(arguments)).isZero() ||
                                      (n = ht.getCanvas(i)))),
                        n ? this.setImage(n) : this.setSource(t)),
                        this._size ||
                            ((this._size = new z()), (this._loaded = !1));
                },
                _equals: function (t) {
                ...
                setSize: function (t, e) {
                    ...
                    i.equals(this._size)
                        ...
                        : (this._canvas && ht.release(this._canvas),
                          (this._size = i.clone()));
                },
                getWidth: function () {
            ...
            },
            {
                ...
                getAverageColor: function (t) {
                    ...
                    t
                        ...
                        : (t = d._sampleContext = ht.getContext(new z(32))),
                        t.save();
                    var i = new A()
                        .scale(e / i.width, n / i.height)
                        .translate(-i.x, -i.y);
                    i.applyToContext(t),
                        r && r.draw(t, new D({ clip: !0, matrices: [i] })),
                        this._matrix.applyToContext(t);
                    var r = this.getElement(),
                        i = this._size;
                    r && t.drawImage(r, -i.width / 2, -i.height / 2),
                        t.restore();
                    for (
        ...
        s = V.extend({
            ...
            initialize: function (t, e) {
                this._initialize(t, e !== F && L.read(arguments, 1)) ||
                    this.setDefinition(t instanceof v ? t : new v(t));
            },
            _equals: function (t) {
                ...
                if (r && "catmull-rom" !== r) {
                    ...
                    !e &&
                        ...
                        this.setHandleIn(
                            0 !== (f = 3 * t * (t + s))
                                ? new L(
                                      (_ * h._x + d * u._x - c * l._x) / f -
                                          u._x,
                                      (_ * h._y + d * u._y - c * l._y) / f -
                                          u._y,
                                  )
                                : new L(),
                        )),
                        !n &&
                            ...
                            this.setHandleOut(
                                0 !== (f = 3 * s * (s + t))
                                    ? new L(
                                          (c * l._x + d * u._x - _ * h._x) / f -
                                              u._x,
                                          (c * l._y + d * u._y - _ * h._y) / f -
                                              u._y,
                                      )
                                    : new L(),
                            ));
        ...
        Z = D.extend(
                    ...
                    3 === _
                        ...
                        ? 1 === _
                            ...
                            : 8 === _ &&
                              ...
                              (f = [r - a, s - o]))
                        : ((h = new H()), (u = new H())),
                        (this._segment1 = h || new H(l, null, d)),
                        (this._segment2 = u || new H(c, f, null));
                },
                _serialize: function (t, e) {
                    return D.serialize(
                        this.hasHandles()
                ...
                remove: function () {
                    ...
                    return (
                        this._path &&
                            ...
                            (n = t.remove()) &&
                                this._segment1._handleOut.set(e)),
                        n
                    );
                },
                getPoint1: function () {
            ...
            },
            {
                ...
                divideAtTime: function (t, e) {
                    ...
                    return (
                        1e-8 <= t &&
                            t <= 1 - 1e-8 &&
                            ((n = (o = Z.subdivide(this.getValues(), t))[0]),
                            (i = o[1]),
                            (r = e || this.hasHandles()),
                            (s = this._segment1),
                            (a = this._segment2),
                ...
                statics: {
                    ...
                    getTimeOf: function (t, e) {
                        ...
                        if (
                            ...
                            for (var r = [e.x, e.y], s = [], a = 0; a < 2; a++)
                                for (
                                    var o = Z.solveCubic(t, a, r[a], s, 0, 1),
                                        h = 0;
                                    h < o;
                                    h++
                                ) {
                                    var u = s[h];
                                    if (e.isClose(Z.getPoint(t, u), 1e-7))
                                        return u;
                                }
                    ...
                    getNearestTime: function (n, i) {
                        if (Z.isStraight(n)) {
                            ...
                            return a < 1e-12
                                ...
                                : 0.999999999999 < a
                                ? 1
                                : Z.getTimeOf(n, new L(t + a * r, e + a * s));
                        }
                        var o = 1 / 0,
                            h = 0;
                        function u(t) {
                    ...
                    isFlatEnough: function (t, e) {
                        var n = t[0],
                            ...
                            i = 3 * o - 2 * t - i;
                        return (
                            Math.max(r * r, n * n) + Math.max(s * s, i * i) <=
                            16 * e * e
                        );
                    },
                    getArea: function (t) {
            ...
            ),
            {
                ...
                getTimesWithTangent: function () {
                    ...
                    return t.isZero()
                        ? []
                        : Z.getTimesWithTangent(this.getValues(), t);
                },
                ...
                getLocationOf: function () {
                    return this.getLocationAtTime(
                        this.getTimeOf(L.read(arguments)),
                    );
                },
                        ...
                        0 === n
                            ...
                            : (0,
                              ...
                              3 === n &&
                                  ...
                                  (u = 6 * d * e + 2 * t),
                                  (f =
                                      0 !== (t = Math.pow(f * f + _ * _, 1.5))
                                          ? (f * u - _ * h) / t
                                          : 0),
                                  (_ = 0))),
                        2 === n ? new L(_, -f) : new L(f, _)
                    );
                }
                return {
                    statics: {
                        classify: function (t) {
                            ...
                            (s = 0 < i ? Math.sqrt(i / 3) : Math.sqrt(-i)),
                                (o *= 2);
                            return u(
                                0 < i ? a : "loop",
                                (r + s) / o,
            ...
            new (function () {
                ...
                function z(t, e, n, i, r, s, a, o, h, u, l, c, d) {
                    ...
                    if (
                        (0 === w &&
                            ...
                            0 === v) ||
                        null == (f = A(m, p, C, S)) ||
                        null == (_ = A(m.reverse(), p.reverse(), C, S))
                    )
                        return h;
                    var M,
                        T,
                ...
                function w(t, e) {
                    ...
                    var i = Math.abs,
                        ...
                        u = l[7] - f;
                    if (
                        r(d, f, _, u, c[0], c[1], !0) < s &&
                        r(d, f, _, u, c[6], c[7], !0) < s
                    )
                        !h &&
                            r(d, f, _, u, l[2], l[3], !0) < s &&
                            r(d, f, _, u, l[4], l[5], !0) < s &&
                            r(d, f, _, u, c[2], c[3], !0) < s &&
                            r(d, f, _, u, c[4], c[5], !0) < s &&
                            (a = o = h = !0);
                    ...
                    return (
                        2 !== v.length
                            ? (v = null)
                            : h ||
                              ((t = Z.getPart(t, v[0][0], v[1][0])),
                              (i(
                                  (e = Z.getPart(e, v[0][1], v[1][1]))[2] -
                                      t[2],
                              ) > s ||
                                  i(e[3] - t[3]) > s ||
                                  i(e[4] - t[4]) > s ||
                        ...
                        getIntersections: function (t, e, n, i, r, s) {
                            ...
                            if (!a)
                                for (d = 0; d < h; d++)
                                    l[d] = e[d].getValues(r);
                            for (
                                var f = R.findCurveBoundsCollisions(u, l, 1e-7),
                                    _ = 0;
                                _ < o;
                                _++
                            ) {
        ...
        U = D.extend(
            {
                ...
                isCrossing: function () {
                    ...
                    (i = this.getPoint()),
                        ...
                        (o = s
                            ? o.getTangentAtTime(e)
                            : o.getPointAt(r).subtract(i)),
                        (h = s ? o.negate() : h.getPointAt(-r).subtract(i)),
                        (u = a
                            ? u.getTangentAtTime(n)
                            : u.getPointAt(r).subtract(i)),
                        ...
                        (u = u.getAngle());
                    return !!(s
                        ? d(h, i, u) ^ d(o, i, u) && d(h, u, i) ^ d(o, u, i)
                        : d(i, h, o) ^ d(u, h, o) && d(i, o, h) ^ d(u, o, h));
                },
                hasOverlap: function () {
                ...
                function i(r, s, t) {
                    ...
                    function i(t, e) {
                        for (var n = t + e; -1 <= n && n <= a; n += e) {
                            var i = r[((n % a) + a) % a];
                            if (!s.getPoint().isClose(i.getPoint(), 1e-7))
                                break;
                    ...
                    for (; e <= n; ) {
                        ...
                        if (t && (o = s.equals(u) ? u : i(h, -1) || i(h, 1)))
                            return (
                                s._overlap &&
                                    (o._overlap = o._intersection._overlap =
                                        !0),
                                o
                            );
                        var l = s.getPath(),
        ...
        m = V.extend({
            ...
            setPathData: function (t) {
                ...
                for (var u = 0, l = i && i.length; u < l; u++) {
                    var c,
                        ...
                        r = f === _;
                    switch (
                        ("z" !== e || /[mz]/.test(_) || this.moveTo(s), _)
                    ) {
                        case "m":
                        case "l":
                            for (var v = "m" === _, p = 0; p < g; p += 2)
                                this[v ? "moveTo" : "lineTo"]((s = h(p))),
                                    v && ((a = s), (v = !1));
                            n = s;
                            break;
                        case "h":
            ...
            interpolate: function (t, e, n) {
                ...
                var e = o.length,
                    h = a.length;
                if (e < h)
                    for (var u = i ? H : W, l = e; l < h; l++)
                        this.add(new u());
                else
                    h < e &&
                        this[i ? "removeSegments" : "removeChildren"](h, e);
            ...
            compare: function (t) {
                ...
                if (t) {
                    ...
                    e = !0;
                    for (
                        var o = R.findItemBoundsCollisions(
                                n,
                                i,
                                q.GEOMETRIC_EPSILON,
                            ),
        ...
        W = m.extend(
            {
                ...
                _equals: function (t) {
                    return (
                        ...
                        D.equals(this._segments, t._segments)
                    );
                },
                copyContent: function (t) {
                ...
                _changed: function t(e) {
                    if ((t.base.call(this, e), 8 & e)) {
                        if (((this._length = this._area = F), 32 & e))
                            this._version++;
                ...
                setSegments: function (t) {
                    ...
                    (this._segments.length = 0),
                        ...
                        (this._curves = F),
                        i &&
                            ("boolean" == typeof (e = t[i - 1]) &&
                                (this.setClosed(e), i--),
                            this._add(H.readList(t, 0, {}, i))),
            ...
            },
            {
                ...
                getPathData: function (n, t) {
                    var i,
                        ...
                        g = [];
                    function v(t, e) {
                        t._transformCoordinates(n, f),
                            (i = f[0]),
                            (r = f[1]),
                            _
                                ? (g.push("M" + d.pair(i, r)), (_ = !1))
                                : ((o = f[2]),
                                  (h = f[3]),
                                  o === i && h === r && u === s && l === a
                                      ? e ||
                    ...
                    return (
                        this._closed && 0 < c && (v(e[0], !0), g.push("z")),
                        g.join("")
                    );
                },
                isEmpty: function () {
                ...
                add: function (t) {
                    ...
                    return 1 < e.length && "number" != typeof t
                        ? this._add(H.readList(e))
                        : this._add([H.read(e)])[0];
                },
                insert: function (t, e) {
                    var n = arguments;
                    return 2 < n.length && "number" != typeof e
                        ? this._add(H.readList(n, 1), t)
                        : this._add([H.read(n, 1)], t)[0];
                },
                addSegment: function () {
                ...
                removeSegments: function (t, e, n) {
                    ...
                    for (var h = 0; h < o; h++) {
                        var u = a[h];
                        u._selection &&
                            this._updateSelection(u, u._selection, 0),
                ...
                flatten: function (t) {
                    for (
                        var e = new y(this, t || 0.25, 256, !0).parts,
                            n = e.length,
                            i = [],
                            r = 0;
                        r < n;
                        ...
                        i.push(new H(e[r].curve.slice(0, 2)));
                    !this._closed &&
                        0 < n &&
                        i.push(new H(e[n - 1].curve.slice(6))),
                        this.setSegments(i);
                },
                simplify: function (t) {
                ...
                smooth: function (t) {
                    ...
                    if (
                        ...
                        var l = "asymmetric" === t,
                            ...
                            _ = [];
                        if (
                            (a || ((f = c(1, h)), (t = c(1, s - u - 1))),
                            !((d += f + t) <= 1))
                        ) {
                            for (var g = 0, v = h - f; g <= d; g++, v++)
                                _[g] = n[(v < 0 ? v + s : v) % s]._point;
                            for (
                                var p = d - 1,
                                    m = [(T = _[0]._x + 2 * _[1]._x)],
                                    y = [(O = _[0]._y + 2 * _[1]._y)],
                                ...
                                var C = g < p,
                                    ...
                                    M = (w[g] = (C ? 4 : l ? 2 : 7) - I),
                                    T = (m[g] =
                                        S * _[g]._x + P * _[g + 1]._x - I * T),
                                    O = (y[g] =
                                        S * _[g]._y + P * _[g + 1]._y - I * O);
                            ...
                            for (
                                ...
                                var z = n[v < 0 ? v + s : v],
                                    ...
                                    L = x[g] - A._x,
                                    A = b[g] - A._y;
                                (o || g < k) && z.setHandleOut(L, A),
                                    (o || f < g) && z.setHandleIn(-L, -A);
                            }
                        }
                    } else
                        for (g = h; g <= u; g++)
                    ...
                    function u(t) {
                        ...
                        if (i.isOrthogonal(r)) {
                            ...
                            return (
                                n &&
                                q.isZero(
                                    i.getLength() / n.subtract(t).getLength() -
                                        s,
                                ) &&
                                q.isZero(
                                    r.getLength() / n.subtract(e).getLength() -
                                        s,
                                )
                            );
                        }
                    ...
                    if (
                        ...
                        a._handleOut.isZero() &&
                            ...
                            : 8 === o.length &&
                              ...
                              h(3, 7)
                            ? ((e = _.Rectangle),
                              (d = (n = new z(l(1, 6), l(0, 3)))
                                  .subtract(new z(l(0, 7), l(1, 2)))
                                  .divide(2)),
                            ...
                            : 4 === o.length &&
                              ...
                              u(2) &&
                              u(3) &&
                              ((d = q.isZero(l(0, 2) - l(1, 3))
                                  ? ((e = _.Circle), l(0, 2) / 2)
                                  : ((e = _.Ellipse),
                                    new z(l(2, 0) / 2, l(3, 1) / 2))),
                              (i = o[1]._point)),
                        e)
                    ) {
                        ...
                        return (
                            d.copyAttributes(this, !0),
                            d._matrix.prepend(this._matrix),
                            d.rotate(i.subtract(c).getAngle() + 90),
                            (t !== F && !t) || d.insertAbove(this),
                            d
                        );
                    }
                    return null;
                ...
                _hitTestSelf: function (n, r, t, i) {
                    ...
                    function b(t, e, n) {
                        if (!r.selected || e.isSelected()) {
                            var i = t._point;
                            if (x((e = e !== i ? e.add(i) : e), v))
                                return new O(n, l, { segment: t, point: e });
                        }
                    }
                    function C(t, e) {
                        return (
                    ...
                    function P(t) {
                        ...
                        return "round" === (e ? s : a)
                            ...
                            : ((h = new W({ internal: !0, closed: !0 })),
                              e
                                  ? t.isSmooth() ||
                                    W._addBevelJoin(t, s, w, o, null, i, S, !0)
                                  : "square" === a &&
                                    W._addSquareCap(t, a, w, null, i, S, !0),
                              !h.isEmpty() &&
                                  (h.contains(n) ||
                                      ((t = h.getNearestLocation(n)) &&
                                          x(t.getPoint(), g))));
                    }
                    if (
                        (null !== w &&
                            (0 < w
                                ? ((s = c.getStrokeJoin()),
                                  (a = c.getStrokeCap()),
                                  (o = c.getMiterLimit()),
                                  (v = v.add(W._getStrokePadding(w, i))))
                                : (s = a = "round")),
                        !r.ends || r.segments || _)
                    ) {
                    ...
                    if (
                        ...
                        ((u = this.getNearestLocation(n)) &&
                            (0 === (c = u.getTime()) || (1 === c && 1 < f)
                                ? P(u.getSegment()) || (u = null)
                                : x(u.getPoint(), v) || (u = null)),
                        !u && "miter" === s && 1 < f)
                    )
                        for (I = 0; I < f; I++) {
                            var M = d[I];
                    ...
                    return (!u && m && this._contains(n)) || (u && !p && !y)
                        ? new O("fill", this)
                        : u
                        ? new O(p ? "stroke" : "curve", this, {
                              location: u,
                              point: u.getPoint(),
                          })
                        : null;
            ...
            new (function () {
                function p(i, t, r) {
                    ...
                    function g(t) {
                        var e, n;
                        (a = r
                            ? (t._transformCoordinates(r, f), (s = f[0]), f[1])
                ...
                return {
                    _draw: function (t, e, n, i) {
                        ...
                        if (
                            (r || t.beginPath(),
                            (o || (h && !l) || s) &&
                                (p(t, this, i), this._closed && t.closePath()),
                            !s &&
                                (o || h) &&
                                (this._setStyles(t, e, n),
                                o &&
                                    (t.fill(a.getFillRule()),
                                    (t.shadowColor = "rgba(0,0,0,0)")),
                                h))
                        ) {
                            if (l) {
                ...
                return {
                    moveTo: function () {
                        ...
                        1 === t.length && this.removeSegment(0),
                            t.length || this._add([new H(L.read(arguments))]);
                    },
                    moveBy: function () {
                        throw new Error(
                    ...
                    cubicCurveTo: function () {
                        ...
                        t.setHandleOut(e.subtract(t._point)),
                            this._add([new H(i, n.subtract(i))]);
                    },
                    ...
                    arcTo: function () {
                        var t,
                            ...
                            a = L.read(e),
                            o = D.peek(e);
                        if ("boolean" == typeof (d = D.pick(o, !0)))
                            var h = (_ = s.add(a).divide(2)).add(
                                _.subtract(s).rotate(d ? -90 : 90),
                            );
                        else if (D.remain(e) <= 2) (h = a), (a = L.read(e));
                        else if (!s.equals(a)) {
                            var u = z.read(e),
                                l = q.isZero;
                            if (l(u.width) || l(u.height))
                                return this.lineTo(a);
                            var c = D.read(e),
                                d = !!D.read(e),
                                f = !!D.read(e),
                                _ = s.add(a).divide(2),
                            ...
                            (w = new L((p * v) / m, (-m * g) / p)
                                .multiply((f === d ? -1 : 1) * i(u))
                                .rotate(c)
                                .add(_)),
                                (c = (x = (t = new A()
                                    .translate(w)
                                    .rotate(c)
                                    .scale(p, m))._inverseTransform(
                                    s,
                                )).getDirectedAngle(t._inverseTransform(a))),
                                !d && 0 < c
                                    ? (c -= 360)
                                    : d && c < 0 && (c += 360);
                        }
                        if (h) {
                            var w,
                                p = new N(
                                    s.add(h).divide(2),
                                    h.subtract(s).rotate(90),
                                    !0,
                                ),
                                m = new N(
                                    h.add(a).divide(2),
                                    a.subtract(h).rotate(90),
                                    !0,
                                ),
                                d = new N(s, a),
                                h = d.getSide(h);
                            ...
                            var x,
                                c = (x = s.subtract(w)).getDirectedAngle(
                                    a.subtract(w),
                                ),
                                d = d.getSide(w, !0);
                            0 === d
                        ...
                        if (c) {
                            for (
                                ...
                                var M,
                                    ...
                                    O = null;
                                I < b &&
                                    ((O = x.rotate(90).multiply(S)),
                                    t
                                        ? ((T = t._transformPoint(x)),
                                          (O = t
                                              ._transformPoint(x.add(O))
                                              .subtract(T)))
                                        : (T = w.add(x))),
                                    I
                                        ? ((M = x.rotate(-90).multiply(S)),
                                          t &&
                                              (M = t
                                                  ._transformPoint(x.add(M))
                                                  .subtract(T)),
                                          P.push(new H(T, M, O)))
                                        : r.setHandleOut(O),
                                    (x = x.rotate(C));
                ...
                statics: {
                    ...
                    getStrokeBounds: function (t, e, n, i, r) {
                        ...
                        function p(t, e) {
                            "round" === e || t.isSmooth()
                                ? v(t)
                                : W._addBevelJoin(t, e, c, f, i, h, g);
                        }
                        function m(t, e) {
                            "round" === e
                                ? v(t)
                                : W._addSquareCap(t, e, c, i, h, g);
                        }
            ...
            return {
                ...
                Rectangle: function () {
                    var t,
                        ...
                        r = z.readNamed(n, "radius", 0, { readNull: !0 }),
                        s = i.getBottomLeft(!0),
                        a = i.getTopLeft(!0),
                        o = i.getTopRight(!0),
                    ...
                    return l(
                        !r || r.isZero()
                            ? [new H(s), new H(a), new H(o), new H(h)]
                            : ((t = (r = z.min(r, i.getSize(!0).divide(2)))
                                  .width),
                              (e = r.height),
                              (i = t * u),
                              (r = e * u),
                              [
                                  new H(s.add(t, 0), null, [-i, 0]),
                                  new H(s.subtract(0, e), [0, r]),
                                  new H(a.add(0, e), null, [0, -r]),
                                  new H(a.add(t, 0), [-i, 0], null),
                                  new H(o.subtract(t, 0), null, [i, 0]),
                                  new H(o.add(0, e), [0, -r], null),
                                  new H(h.subtract(0, e), null, [0, r]),
                                  new H(h.subtract(t, 0), [i, 0]),
                              ]),
                        !0,
                        n,
                    );
                ...
                RegularPolygon: function () {
                    for (
                        ...
                        h[u] = new H(e.add(a.rotate((u + o) * r)));
                    return l(h, !0, t);
                },
                Star: function () {
                    for (
                        var t = arguments,
                            e = L.readNamed(t, "center"),
                            n = 2 * D.readNamed(t, "points"),
                            i = D.readNamed(t, "radius1"),
                            r = D.readNamed(t, "radius2"),
                            s = 360 / n,
                            a = new L(0, -1),
                            o = new Array(n),
                            h = 0;
                        ...
                        o[h] = new H(
                            e.add(a.rotate(s * h).multiply(h % 2 ? r : i)),
                        );
                    return l(o, !0, t);
                },
            };
    ...
    var G = m.extend(
        {
            ...
            insertChildren: function t(e, n) {
                ...
                for (var s = n.length - 1; 0 <= s; s--) {
                    var a = i[s];
                    i !== n || a instanceof W || (i = D.slice(i)),
                        Array.isArray(a)
        ...
        D.each(
            ...
            function (s) {
                this[s] = function (t) {
                    for (
                        var e, n = this._children, i = 0, r = n.length;
                        i < r;
                        i++
                    )
                        e = n[i][s](t) || e;
    ...
    m.inject(
        new (function () {
            ...
            function n(t, e, n, i) {
                ...
                (a[n] = !0),
                    s &&
                        (a.subtract || a.exclude) ^
                            (s.isClockwise() ^ r.isClockwise()) &&
                        s.reverse();
                var o,
                    h = z(U.expand(r.getIntersections(s, M))),
                    u = S(r),
                    n = s && S(s),
                    l = [],
                    c = [];
                function d(t) {
                    for (var e = 0, n = t.length; e < n; e++) {
                        var i = t[e];
                        D.push(l, i._segments),
                            D.push(c, i.getCurves()),
                            (i._overlapsOnly = !0);
                    }
                }
                function f(t) {
                ...
                if (h.length) {
                    d(u), n && d(n);
                    for (
                        var _ = new Array(c.length), g = 0, v = c.length;
                        g < v;
                        g++
                    )
                        _[g] = c[g].getValues();
                    for (
                        var p = R.findCurveBoundsCollisions(_, _, 0, !0),
                            m = {},
                            g = 0;
                        g < c.length;
                        g++
                    ...
                    for (g = 0, v = h.length; g < v; g++)
                        E(h[g]._segment, r, s, m, a);
                    for (g = 0, v = l.length; g < v; g++) {
                        var x = l[g],
                            b = x._intersection;
                        x._winding || E(x, r, s, m, a),
                            (b && b._overlap) || (x._path._overlapsOnly = !1);
                    }
                    o = j(l, a);
                } else
                    o = k(n ? u.concat(n) : u.slice(), function (t) {
                        return !!a[t];
                    });
                return I(o, !0, t, e, i);
            }
            function T(t, e, n) {
                ...
                function l(t) {
                    return (
                        !h[t._id] &&
                        (o ||
                            r.contains(t.getPointAt(t.getLength() / 2)) ^ a) &&
                ...
                for (var c = s.length - 1; 0 <= c; c--) {
                    var d = s[c].split();
                    d &&
                        (l(d) && d.getFirstSegment().setHandleIn(0, 0),
                ...
                if (i) {
                    ...
                    for (var h = 0; h < i; h++) {
                        ...
                        e(c.winding) === e(d)
                            ...
                            : ((u = c.container),
                              l.setClockwise(u ? !u.isClockwise() : n));
                    }
                }
                return t;
            }
                ...
                for (c = t.length - 1; 0 <= c; c--) {
                    ...
                    if (
                        ...
                        if ((e && a.unshift(f), (s = g), _ < 1e-8))
                            ...
                            o && h.push(d, g);
                            for (
                                var p = g._segment1, m = i.length - 1;
                                0 <= m;
                                m--
                            ) {
                                var y = i[m];
            ...
            function E(t, e, n, i, r) {
                ...
                do {} while (
                    ((v = t.getCurve()) &&
                        ((c = v.getLength()),
                        s.push({ segment: t, curve: v, length: c }),
                        (o += c)),
                    (t = t.getNext()) && !t._intersection && t !== a)
                );
                for (
                    var h = [0.5, 0.25, 0.75],
                        u = { winding: 0, quality: -1 },
                        l = 0;
                    ...
                    for (var c = o * h[l], d = 0, f = s.length; d < f; d++) {
                        ...
                        if (c <= g) {
                            var v,
                                ...
                                w = q.clamp(v.getTimeAt(c), 0.001, 0.999),
                            ...
                            (m = m || B(x, i[p._id][v.getIndex()], _, !0))
                                .quality > u.quality && (u = m);
                            break;
                        }
                        c -= g;
                    }
            ...
            function j(t, e) {
                ...
                for (var r = 0, s = t.length; r < s; r++) {
                    ...
                    for (
                        ...
                        ((d = _._path),
                        (f = _._intersection._segment._path),
                        d.compare(f) &&
                            (d.getArea() && n.push(d.clone(!1)),
                            i(d),
                            i(f),
                            (g = !1)));
                        g;
                        ...
                        b = _.getNext();
                        v.add(new H(_._point, c, b && _._handleOut)),
                            (_._visited = !0),
                            o.push(_),
                    ...
                    p &&
                        (m &&
                            (v.getFirstSegment().setHandleIn(c),
                            v.setClosed(m)),
                        0 !== v.getArea() && n.push(v));
                }
                return n;
            }
            return {
                        ...
                        for (
                            ...
                            n(d, l) &&
                                ...
                                d === c ||
                                    ...
                                    (u._handleIn.set(d._handleIn), d.remove()));
                        }
                    r &&
                        (z(
                            s,
                    ...
                    return (
                        1 < a && t
                            ...
                            : 1 !== a ||
                              ...
                              (f = this)),
                        f ||
                            ((f = new G(V.NO_INSERT)).addChildren(e),
                            (f = f.reduce()).copyAttributes(this),
                            this.replaceWith(f)),
                        f
                    );
                },
    ...
    var y = D.extend(
        ...
        h = D.extend({
            initialize: function (t) {
                ...
                t && (n.unshift(n[n.length - 1]), n.push(n[1])),
                    (this.closed = t);
            },
            fit: function (t) {
                var e = this.points,
            ...
            addCurve: function (t, e) {
                t[t.length - 1].setHandleOut(e[1].subtract(e[0])),
                    t.push(new H(e[3], e[2].subtract(e[3])));
            },
            ...
            _draw: function (t, e, n) {
                if (this._content) {
                    ...
                    var i = this._lines,
                        ...
                        a = n.getLeading(),
                        o = t.shadowColor;
                    (t.font = n.getFontStyle()),
                        (t.textAlign = n.getJustification());
                        ...
                        initialize: function t(e) {
                            ...
                            if (((this._type = h || "rgb"), !n)) {
                                ...
                                for (
                                    var v,
                                        c = 0,
                                        d = (g = y[this._type]).length;
                                    c < d;
                                    c++
                                )
                                    null != (v = g[c].call(this, i && i[c])) &&
                                        (n[c] = v);
                            }
                            return (
                                (this._components = n),
        ...
        P = D.extend({
            ...
            initialize: function (t, e) {
                (this._id = o.get()),
                    t && D.isPlainObject(t) && (this.set(t), (t = e = null)),
                    null == this._stops &&
            ...
            _removeOwner: function (t) {
                ...
                -1 != t &&
                    ...
                    this._owners.length || (this._owners = F));
            },
            clone: function () {
            ...
            setStops: function (t) {
                ...
                for (
                    n = 0,
                        i = (e = this._stops = I.readList(t, 0, { clone: !0 }))
                            .length;
                    n < i;
                    n++
                )
        ...
        I = D.extend({
            ...
            setColor: function () {
                S._setOwner(this._color, null),
                    (this._color = S._setOwner(
                        S.read(arguments, 0),
                        this,
                        "setColor",
                    )),
        ...
        k = new (function () {
            ...
            return {
                ...
                isInView: function (t) {
                    return (
                        !k.isInvisible(t) &&
                        k.getViewportBounds(t).intersects(k.getBounds(t, !0))
                    );
                },
                isInserted: function (t) {
        ...
        B = {
            ...
            getPoint: function (t) {
                t = t.targetTouches
                    ...
                    : t;
                return new L(
                    t.pageX || t.clientX + f.documentElement.scrollLeft,
                    t.pageY || t.clientY + f.documentElement.scrollTop,
                );
            },
    ...
    B.requestAnimationFrame = new (function () {
        var e,
            i = k.getPrefixed(T, "requestAnimationFrame"),
            r = !1,
            s = [];
        function a() {
            var t = s;
        ...
        Y = D.extend(
            t,
            {
                ...
                initialize: function t(e, n) {
                    ...
                    T && n
                        ? ((this._id = n.getAttribute("id")),
                          ...
                          B.add(n, this._viewEvents),
                          k.setPrefixed(n.style, {
                              userDrag: (u = "none"),
                              userSelect: u,
                              touchCallout: u,
                              contentZooming: u,
                        ...
                        (this._element = n),
                        this._pixelRatio ||
                            (this._pixelRatio = (T && T.devicePixelRatio) || 1),
                        this._setElementSize(s.width, s.height),
                        (this._viewSize = s),
                        t._views.push(this),
                        (((t._viewsById[this._id] = this)._matrix =
                            new A())._owner = this),
                ...
                remove: function () {
                    ...
                    return (
                        ...
                        B.remove(this._element, this._viewEvents),
                        B.remove(T, this._windowEvents),
                        ...
                        B.requestAnimationFrame(function () {
                            ...
                            (e._requested = !1),
                                e._animate &&
                                    (e.requestUpdate(),
                                    (t = e._element),
                                    (k.getPrefixed(f, "hidden") &&
                                        "true" !==
                                            l.getAttribute(t, "keepalive")) ||
                                        !k.isInView(t) ||
                                        e._handleFrame()),
                ...
                _changed: function () {
                    this._project._changed(4097),
                        (this._bounds = this._decomposed = F);
                },
                getElement: function () {
                ...
                getPixelSize: function (t) {
                    ...
                    return (
                        i
                            ? ((n = i.parentNode),
                              ((i = f.createElement("div")).style.fontSize = t),
                              n.appendChild(i),
                              (e = parseFloat(k.getStyles(i).fontSize)),
                              n.removeChild(i))
                            : (e = parseFloat(e)),
                        e
                    );
            ...
            D.each(
                ...
                },
                {
                    ...
                    setZoom: function (t) {
                        this.transform(
                            new A().scale(t / this.getZoom(), this.getCenter()),
                        );
                    },
                    getRotation: function () {
                    ...
                    var o = {},
                        a = {
                            mouseout: function (t) {
                                ...
                                !r ||
                                    (s && "HTML" !== s.nodeName) ||
                                    ((n = (e = B.getOffset(t, r._element)).x),
                                    (s = (i = Math.abs)(n)),
                                    (e.x =
                                        i((i = s - (1 << 25))) < s
                                            ? i * (n < 0 ? -1 : 1)
                                            : n),
                                    d(r, t, r.viewToProject(e)));
                            },
                            scroll: c,
                        };
                    (o[t] = function (t) {
                        ...
                        (a[n] = function (t) {
                            var e = Y._focused;
                            e && _ && e._handleMouseEvent("mouseup", t),
                                (s = _ = !1);
                        }),
                        B.add(f, a),
                        B.add(T, { load: c });
                    ...
                    return {
                        ...
                        _handleMouseEvent: function (t, e, n) {
                            ...
                            (v = n),
                                d &&
                                    a &&
                                    (C = a._handleMouseEvent(t, e, n, l) || C),
                                !1 !== e.cancelable &&
                                    ((C && !l.move) ||
                                        (l.down && h("mouseup"))) &&
                                    e.preventDefault();
                        ...
                        _handleKeyEvent: function (e, n, i, r) {
                            ...
                            function o(t) {
                                t.responds(e) &&
                                    ((Bt = a),
                                    t.emit(e, (s = s || new nt(e, n, i, r))));
                            }
                            this.isVisible() &&
                                (o(this), t && t.responds(e) && o(t));
                        },
            ...
            initialize: function (t, e) {
                ...
                i.save(),
                    ...
                    /^off|false$/.test(l.getAttribute(e, "hidpi")) ||
                        ...
                        (i = k.getPrefixed(i, "backingStorePixelRatio") || 1),
            ...
            function s(t) {
                var e = t.key || t.keyIdentifier,
                    e = /^U\+/.test(e)
                        ...
                        : e;
                return (
                    n[e] || (1 < e.length ? D.hyphenate(e) : e.toLowerCase())
                );
            }
            function d(t, e, n, i) {
                var r,
                ...
                if (
                    ...
                    1 < e.length && (r = D.camelize(e)) in c)
                ) {
                    c[r] = t;
                    var a = Bt && Bt.agent;
                    if ("meta" === r && a && a.mac)
        ...
        at =
            (e.extend({
                ...
                _handleMouseEvent: function (t, e, a, o) {
                    (Bt = this._scope),
                        o.drag && !this.responds(t) && (t = "mousemove");
                    var h = o.move || o.drag,
                        n = this.responds(t),
                        i = this.minDistance,
                        r = this.maxDistance,
                    ...
                    overlay: function () {
                        (b =
                            ...
                            (S =
                                w < 128
                                    ? (2 * w * v) / 255
                                    : 255 - (2 * (255 - w) * (255 - v)) / 255);
                    },
                    "soft-light": function () {
                        var t = (_ * m) / 255;
                        (b =
                            t +
                            (m * (255 - ((255 - m) * (255 - _)) / 255 - t)) /
                                255),
                            (C =
                                (t = (g * y) / 255) +
                                (y *
                                    (255 - ((255 - y) * (255 - g)) / 255 - t)) /
                                    255),
                            (S =
                                (t = (v * w) / 255) +
                                (w *
                                    (255 - ((255 - w) * (255 - v)) / 255 - t)) /
                                    255);
                    },
                    "hard-light": function () {
                        (b =
                    ...
                    try {
                        (r.fillStyle = n ? "#300" : "#a00"),
                            ...
                            r.globalCompositeOperation === e &&
                                ...
                                r.fillRect(0, 0, 1, 1),
                                (i =
                                    r.getImageData(0, 0, 1, 1).data[0] !== n
                                        ? 170
                                        : 51));
                    } catch (t) {}
                    r.restore(), (I[e] = i);
        ...
        lt = new (function () {
            ...
            return {
                ...
                get: function (t, e) {
                    var n = a[e];
                    return "null" ===
                        (e = n ? t.getAttributeNS(n, e) : t.getAttribute(e))
                        ? null
                        : e;
                },
                set: r,
        ...
        ct = D.each(
            {
                ...
                strokeScaling: [
                    ...
                    function (t, e) {
                        return (
                            !e &&
                            (t instanceof m || t instanceof _ || t instanceof w)
                        );
                    },
                ],
    ...
    function dt(t, e, n) {
        ...
        return (
            e &&
                (t.isInvertible()
                    ? ((i = (t = t._shiftless())._inverseTransform(a)),
                      (a = null))
                    : (i = new L()),
                (s[n ? "cx" : "x"] = i.x),
                (s[n ? "cy" : "y"] = i.y)),
            t.isIdentity() ||
                ((r = t.decompose())
                    ? ((e = []),
                      ...
                      a &&
                          !a.isZero() &&
                          e.push("translate(" + E.point(a) + ")"),
                      n && e.push("rotate(" + E.number(n) + ")"),
                      (q.isZero(i.x - 1) && q.isZero(i.y - 1)) ||
                          e.push("scale(" + E.point(i) + ")"),
                      r.x && e.push("skewX(" + E.number(r.x) + ")"),
                      r.y && e.push("skewY(" + E.number(r.y) + ")"),
                      (s.transform = e.join(" ")))
                    : (s.transform =
                          "matrix(" + t.getValues().join(",") + ")")),
            s
        );
    }
    function ft(t, e) {
        for (
            ...
            u &&
                (h.isClipMask()
                    ? ((o = lt.create("clipPath")).appendChild(u),
                      pt(h, o, "clip"),
                      lt.set(r, { "clip-path": "url(#" + o.id + ")" }))
                    : r.appendChild(u));
        }
        return r;
    }
    ...
    function mt(t, e) {
        var n = t,
            i = null;
        if (j) {
            for (var r in ((n = "svg" === t.nodeName.toLowerCase() && t),
            j.svgs))
                i ||
                    (n || (n = lt.create("svg")).appendChild(t),
                    (i = n.insertBefore(lt.create("defs"), n.firstChild))),
                    i.appendChild(j.svgs[r]);
            j = null;
        }
    ...
    function bt(t, e, n, i, r, s, a) {
        return (
            (e = xt(t, e || "x", !1, i, r, s)),
            (n = xt(t, n || "y", !1, i, r, a)),
            !i || (null != e && null != n) ? new L(e, n) : null
        );
    }
    function Ct(t, e, n, i, r) {
        return (
            (e = xt(t, e || "width", !1, i, r)),
            (n = xt(t, n || "height", !1, i, r)),
            !i || (null != e && null != n) ? new z(e, n) : null
        );
    }
    function St(t, e, n) {
        return "none" === t
    ...
    function Pt(t, e, n, i) {
        ...
        if (
            (s ||
                a ||
                ((o = zt(o, t, i)), (h._currentStyle = o._style.clone())),
            i)
        )
            for (
                var l = t.querySelectorAll("defs"), c = 0, d = l.length;
                c < d;
                c++
            )
                Lt(l[c], n, !1);
    ...
    function It(t, e) {
        for (
            ...
            i.push(new L(parseFloat(n[r]), parseFloat(n[r + 1])));
        t = new W(i);
        return "polygon" === e && t.closePath(), t;
    }
    function Mt(t, e) {
        var n,
            i = (xt(t, "href", !0) || "").substring(1),
            e = "radialgradient" === e;
        if (i)
            (n = K[i].getGradient())._radial ^ e &&
                ((n = n.clone())._radial = e);
        else {
            for (
                var r = t.childNodes, s = [], a = 0, o = r.length;
                a < o;
                a++
            ) {
                var h = r[a];
        ...
        var u,
            l,
            c,
            i = "userSpaceOnUse" !== xt(t, "gradientUnits", !0);
        return (
            e
                ? ((l = (u = bt(t, "cx", "cy", !1, i, "50%", "50%")).add(
                      xt(t, "r", !1, !1, i, "50%"),
                      0,
                  )),
                  (c = bt(t, "fx", "fy", !0, i)))
                : ((u = bt(t, "x1", "y1", !1, i, "0%", "0%")),
                  (l = bt(t, "x2", "y2", !1, i, "100%", "0%"))),
            (zt(new S(n, u, l, c), t)._scaleToBounds = i),
            null
        );
    }
    function Tt(t, e, n, i) {
    ...
    function zt(i, r, t) {
        var e = r.parentNode,
            s = {
                node: k.getStyles(r) || {},
                parent:
                    (!t && !/^defs$/i.test(e.tagName) && k.getStyles(e)) || {},
            };
        return (
    ...
    function At(t) {
        (t = t && t.match(/\((?:["'#]*)([^"')]+)/)),
            ...
            (t =
                t &&
                K[T ? t.replace(T.location.href.split("#")[0] + "#", "") : t]);
        return (
            t && t._scaleToBounds && ((t = t.clone())._scaleToBounds = !0), t
        );
    }
    function Lt(t, e, n) {
        var i,
        ...
        return (
            ...
            n &&
                ((K = {}),
                a && D.pick(e.applyMatrix, l) && a.matrix.apply(!0, !0)),
            a
        );
    }
    function Nt(i, r, s) {
        ...
        function t(t) {
            try {
                ...
                if (!e.nodeName)
                    throw (
                        ((e = null), new Error("Unsupported SVG source: " + i))
                    );
                (Bt = a),
                    (o = Lt(e, r, !0)),
                    (r && !1 === r.insert) || s._insertItem(F, o);
                var n = r.onLoad;
                n && n(o, t);
            } catch (t) {
                h(t);
        ...
        if ("string" != typeof i || /^[\s\S]*</.test(i)) {
            ...
            n ? t(n) : ot({ url: i, async: !0, onLoad: t, onError: h });
        }
        return o;
    }
    ($ = {
        ...
        Path: function (t, e) {
            ...
            if (n && 2 <= s && !t.hasHandles())
                if (2 < s) {
                    for (
                        var o = t._closed ? "polygon" : "polyline",
                            h = [],
                            u = 0;
                        u < s;
                        u++
                    )
                        h.push(E.point(r[u]._point));
                    a.points = h.join(" ");
                } else {
                    o = "line";
        ...
        i.inject({
            exportSVG: function (t) {
                ...
                n &&
                    ...
                    (i.height = n.height),
                    (n.x || 0 === n.x || n.y || 0 === n.y) &&
                        (i.viewBox = E.rectangle(n)));
                var i = lt.create("svg", i, E),
                    s = i;
                r &&
                    !r.isIdentity() &&
                    (s = i.appendChild(lt.create("g", dt(r), E)));
                for (var a = 0, o = e.length; a < o; a++)
                    s.appendChild(yt(e[a], t, !0));
                return mt(i, t);
            },
        }),
        (K = {}),
        ...
        (X = D.set(
            ...
            ),
            {
                ...
                "clip-path": function (t, e) {
                    ...
                    if (e) {
                        if (
                            ((e = e.clone()).setClipMask(!0), !(t instanceof g))
                        )
                            return new g(e, t);
                        t.insertChild(0, e);
                    }
                ...
                viewBox: function (t, e, n, i, r) {
                    ...
                    t instanceof g
                        ? ((a = e ? e.divide(o.getSize()) : 1),
                          (s = new A()
                              .scale(a)
                              .translate(o.getPoint().negate())),
                          (a = t))
                        : t instanceof v && (e && o.setSize(e), (a = t._item)),
                        a &&
                            ("visible" !== kt(i, "overflow", r) &&
                                ((o = new _.Rectangle(o)).setClipMask(!0),
                                a.addChild(o)),
                            s && a.transform(s));
                },
            },
